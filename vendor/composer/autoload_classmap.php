...
return array(
    ...
    'WpOtp\\WP_OTP_Delivery_Email' => $baseDir . '/includes/class-delivery-email.php',
    'WpOtp\\WP_OTP_Logger' => $baseDir . '/includes/class-logger.php',
    'WpOtp\\WP_OTP_Manager' => $baseDir . '/includes/class-otp-manager.php',
    'WpOtp\\WP_OTP_Rate_Limiter' => $baseDir . '/includes/class-rate-limiter.php',
    'WpOtp\\WP_OTP_Repository' => $baseDir . '/includes/class-otp-repository.php',
    'WpOtp\\WP_OTP_SMS_019_Client' => $baseDir . '/includes/class-sms-019-client.php',
    'WpOtp\\WP_OTP_Shortcodes' => $baseDir . '/includes/class-shortcodes.php',
);
