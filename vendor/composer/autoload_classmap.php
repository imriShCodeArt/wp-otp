...
return array(
    ...
    'WP_OTP_Admin_Ajax' => $baseDir . '/admin/class-admin-ajax.php',
    'WP_OTP_Admin_Page' => $baseDir . '/admin/class-admin-page.php',
    'WP_OTP_Auth_Overrides' => $baseDir . '/includes/class-auth-overrides.php',
    'WP_OTP_Logger' => $baseDir . '/includes/class-logger.php',
    'WP_OTP_Rate_Limiter' => $baseDir . '/includes/class-rate-limiter.php',
    'WP_OTP_SMS_019_Client' => $baseDir . '/includes/class-sms-019-client.php',
